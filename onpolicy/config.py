...
def get_config():
    ...
    parser.add_argument("--use_feature_normalization", action='store_false',
                        default=False, help="Whether to apply layernorm to the inputs") #default=True but not working with batch size =1. because it calculates var std ... so it is not possible with one values
