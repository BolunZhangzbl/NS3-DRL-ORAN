...
class SharedReplayBuffer(object):
    ...
    def __init__(self, args, num_agents, obs_space, cent_obs_space, act_space):
        ...
        obs_shape = (1,)#get_shape_from_obs_space(obs_space)
        share_obs_shape = (int(args.num_agents),)# len(1) is by default if list then it can be changed #get_shape_from_obs_space(cent_obs_space)
